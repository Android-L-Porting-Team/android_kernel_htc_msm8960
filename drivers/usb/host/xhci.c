...
static inline xhci_try_enable_msi(struct usb_hcd *hcd)
{
	return 0;
}

static inline xhci_cleanup_msix(struct xhci_hcd *xhci)
{
}
...
#ifdef CONFIG_PCI
static inline xhci_msix_sync_irqs(struct xhci_hcd *xhci)
{
	int i;
